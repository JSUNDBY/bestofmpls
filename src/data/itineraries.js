  ...
  plans: [
    {
      ...
      stops: [
        { time: '9:00 AM', title: 'Coffee + pastry at Patisserie 46 or Sun Street Breads', body: 'Start with the bakery. The almond croissant at Patisserie 46 in South Mpls is the pastry-program flex. If you are downtown, Sun Street in Lyn-Lake is just as good and walkable to the next stop.', linkSlug: 'pastries-and-bakeries' },
        ...
        { time: '12:30 PM', title: 'Lunch: Owamni or Hai Hai', body: 'If you want the most important Minneapolis restaurant of the last decade, Owamni (Indigenous, James Beard Best New Restaurant 2022) on the Mississippi. If you want a faster casual lunch, Hai Hai in Northeast does Southeast Asian street food brilliantly.', linkSlug: 'restaurants' },
    ...
    },
    {
      ...
      stops: [
        ...
        { time: 'Saturday 5pm', title: 'Northeast art crawl + early dinner', body: 'Drop into the Northrup King Building if it is First Saturday. Otherwise wander 13th Ave NE. Dinner at Young Joni (Ann Kim, James Beard) or Centro for tacos.', linkSlug: 'museums-and-galleries' },
        ...
        { time: 'Sunday 10am', title: 'Brunch at Birchwood Cafe or Tilia', body: 'Birchwood for the locally-sourced Seward classic. Tilia for Steven Brown\'s Linden Hills neighborhood bistro. Either way order coffee.', linkSlug: 'best-brunch' },
    ...
    },
    {
      ...
      stops: [
        { time: 'Day 1', title: 'Arrival, downtown orientation, Mia', body: 'Settle in. Walk Nicollet Mall and the Stone Arch Bridge. Visit Mia if it is open. Dinner at Owamni or 112.', linkSlug: 'museums-and-galleries' },
        { time: 'Day 2', title: 'Northeast Minneapolis day', body: 'Spend the whole day in NE. Coffee at Cafe Cerés, lunch at Vinai, art at Northrup King, dinner at Young Joni, late drink at Norseman or Tattersall.', linkSlug: 'neighborhoods' },
        ...
        { time: 'Day 4', title: 'Lakes day', body: 'Bike the Chain of Lakes. Swim at Bde Maka Ska Beach or Hidden Beach on Cedar Lake. Dinner on a patio (Bryant Lake Bowl rooftop, Sea Salt Eatery at Minnehaha Falls in summer).', linkSlug: 'outdoors' },
        ...
        { time: 'Day 7', title: 'Slow last day', body: 'Long brunch (Hai Hai, Saint Dinette, or Tilia). Browse a shop you have not been to (Magers & Quinn, Birchbark Books, COMBINE). One last meal at a place you loved earlier in the week. Head home.', linkSlug: 'independent-shops' }
      ]
    }
  ]
};
